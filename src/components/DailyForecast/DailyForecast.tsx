...
const DailyForecast = () => {
  const days = [
    { name: 'FRI', icon: <CloudRain className="h-5 w-5 mx-auto" />, temp: '14°' },
    { name: 'SAT', icon: <Sun className="h-5 w-5 mx-auto" />, temp: '17°' },
    { name: 'SUN', icon: <CloudRain className="h-5 w-5 mx-auto" />, temp: '16°' },
    { name: 'MON', icon: <CloudRain className="h-5 w-5 mx-auto" />, temp: '15°' },
    { name: 'TUE', icon: <CloudRain className="h-5 w-5 mx-auto" />, temp: '14°' }
  ];
