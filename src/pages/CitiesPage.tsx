...
const featuredCities = [
  {
    ...
    temp: 32,
    weather: "Clouds",
    icon: <Cloud className="h-8 w-8 text-blue-400 animate-bounce" />,
    image: "/HaNoi.jpg",
  },
  {
    name: "TP. Hồ Chí Minh",
    temp: 34,
    weather: "Clear",
    icon: <Sun className="h-8 w-8 text-yellow-400 animate-spin-slow" />,
    image: "/HoChiMinh.jpg",
  },
  {
    name: "Đà Nẵng",
    temp: 30,
    weather: "CloudSun",
    icon: <CloudSun className="h-8 w-8 text-orange-300 animate-pulse" />,
    image: "/Da Nang.jpg",
  },
  {
    name: "New York",
    temp: 25,
    weather: "Rain",
    icon: <CloudRain className="h-8 w-8 text-blue-600 animate-bounce" />,
    image: "/NewYork.jpg",
  },
  {
    name: "London",
    temp: 20,
    weather: "Clouds",
    icon: <Cloud className="h-8 w-8 text-gray-400 animate-bounce" />,
    image: "/London.jpg",
  },
];
  ...
  return (
    <div className="relative w-full min-h-screen pb-40 bg-gradient-to-br from-blue-100 to-blue-300 overflow-auto">
      ...
      <div className="relative z-10 flex flex-col items-center px-4 pt-8">
        <h1 className="text-4xl font-bold mb-4 text-blue-900 drop-shadow-lg animate-fade-in">
          🌏 Cities Weather
        </h1>
        <p className="text-lg text-gray-700 mb-8 animate-fade-in">
          Xem nhanh thời tiết của các thành phố lớn trên thế giới.
        </p>
          ...
          {featuredCities.map((city, idx) => (
            ...
            >
              ...
              <div className="flex items-center mb-1">
                ...
                <span className="font-semibold text-lg text-blue-800 group-hover:text-blue-600 transition">
                  {city.name}
                </span>
              </div>
